...
Hear about new endpoints, breaking changes, and deprecations before they ship.

Turn it on in the sajn app under **Inställningar → Utvecklare**, or in the *Utvecklare* section of your [notification settings](https://app.sajn.se). Updates go to your account's email address, and you can unsubscribe from any newsletter email.
