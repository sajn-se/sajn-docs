...
<AccordionGroup>
  ...
  <Accordion title="defaultSignatureType">
    **DRAWING**: Free-hand signature (SES)
    **SMS_DRAWING**: SMS + Free-hand signature (SES)
    **BANKID**: Swedish BankID electronic signature (AES)
    **CLICK_TO_SIGN**: Click-to-sign signature (SES)
  </Accordion>
