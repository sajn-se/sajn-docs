...
- **`signatureType`** - Default signature method: `BANKID`, `DRAWING`, or `MANUAL`
...
- [Document Fields API](/api-reference/PATCH%20/api/v1/documents/{id}/fields/{fieldId}) - Field update reference
